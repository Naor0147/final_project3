...
namespace final_project3.Classes
{
    ...
    public class Settings_class
    {
        ...
        I draw and work on the Imaginary Canvas is size doesnt change ,even if you change the window size ,
        then i after i draw on the imaginary canvas i convert the object postion and size to the size of the 
        ...
        public static double Convert_To_Real(double value, Canvas _canvas) => value * (_canvas.ActualHeight / IMAGINARY_SCREEN_HEIGHT);
